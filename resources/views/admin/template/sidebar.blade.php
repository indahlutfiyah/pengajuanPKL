...
<!--End Header-->
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pklrekap">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="magang1individu">
              <i class="bi bi-circle"></i><span>Individu</span>
            </a>
          </li>
          <li>
            <a href="magang1kelompok">
              <i class="bi bi-circle"></i><span>Kelompok</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        ...
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="magang2individu">
              <i class="bi bi-circle"></i><span>Individu</span>
            </a>
          </li>
          <li>
            <a href="magang2kelompok">
              <i class="bi bi-circle"></i><span>Kelompok</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="magangrekap">
          <i class="bi bi-archive"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="logbookpkl">
